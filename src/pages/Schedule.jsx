...
const Schedule = () => {
  ...
  return (
    <div style={{ padding: '20px', backgroundColor: isDarkMode ? theme.palette.background.default : theme.palette.background.paper, [theme.breakpoints.down('sm')]: { padding: '10px' } }}>
      <Typography variant="h4" gutterBottom>Órarend</Typography>
      <Grid container spacing={2}>
        {Object.keys(schedule).map(day => (
          <Grid item xs={12} sm={6} md={4} key={day}>
            <Paper style={{ padding: '10px', backgroundColor: isDarkMode ? theme.palette.background.paper : theme.palette.background.default }}>
